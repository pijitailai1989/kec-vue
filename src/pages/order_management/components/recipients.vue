  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="col-sm-6">
        <kec-form text="公司">
          <template #input>
            <el-input v-model="payload.company" placeholder="" size="medium"></el-input>
          </template>
        </kec-form>
      </div>
      <div class="col-sm-6">
      ...
      <div class="col-sm-6">
        <kec-form text="城市">
          <template #input>
            <div class="flexs">
              <el-input v-model="payload.city" placeholder="" size="medium" class="flx"></el-input>
      ...
      <div class="col-sm-6">
        <kec-form text="地址">
         <template #input>
           <div class="flexs">
              <el-input v-model="payload.address" placeholder="" size="medium" class="flx"></el-input>
      ...
      <div class="col-sm-6">
        <kec-form text="国家">
          <template #input>
            <div class="flexs">
              <el-input v-model="payload.countryCode" placeholder="" size="medium" class="flx"></el-input>
    ...
    watch: {
      orderInfos:{
        ...
        handler:function(val){
          ...
          // this.payload = JSON.parse( JSON.stringify(receiver) )
        }
      }
    }
