  ...
  export default {
    ...
    data () {
      return {
           ...
           lastWidth:'',
           tableHeader:{
             code:{"title":'货态编码','slot':false},
             name:{"title":'货态中文名称','slot':false},
             nameEn:{"title":'货态英文名称','slot':false},
             description:{"title":'描述','slot':false},
             standardStateName:{"title":'关联的标准货态名称','slot':false},
             standardStateCode:{"title":'关联的标准货态编码','slot':false}
