  ...
  <kec-scroll :numbers="179" class="flexs columns a-center">
    ...
    <div class="kec-content">
        <div class="tableHeader flexs" :style="{background:themeColor.content_border_color}">
          <div-sort class="padd" style="min-width:249px" @clickSort="sortFunc" :sortType="{a:'code',b:'ZH'}">编码</div-sort>
...
import {KecButton , KecTable ,KecScroll,KecSort }  from '@/common/components'
