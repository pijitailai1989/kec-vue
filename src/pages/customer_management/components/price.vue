    ...
    data () {
      return {
         tableData: [],
           ...
           lastWidth:'',
           tableHeader:{
             id:{"title":'报价方式','slot':false},
             channelCode:{"title":'服务类型','slot':false},
             averageCostWeight:{"title":'收费项目','slot':false},
             averageCostVolume:{"title":'科目名称','slot':false},
             grossProfit:{"title":'科目编号','slot':false},
             useTime:{"title":'费率','slot':false},
             useTime1:{"title":'币种','slot':false},
             useTime2:{"title":'收费单位','slot':false},
             useTime3:{"title":'生效日期','slot':false}
            },
            selectIndex:null,
            selectItem:null,
            addVisible:false,
